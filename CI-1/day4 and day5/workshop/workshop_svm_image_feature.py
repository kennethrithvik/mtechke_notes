"""
KE5206 CI1 workshop SVM + image feature engineering
Reference: https://github.com/pavitrakumar78/Python-Custom-Digit-Recognition
...
# Manual configuration for demonstration purpose
DIGIT_WIDTH = 10 
DIGIT_HEIGHT = 20
IMG_HEIGHT = 28
IMG_WIDTH = 28
...
def load_digits(fn):
    ...
    resized_digits = []
    for digit in digits:
        resized_digits.append(resize(digit,(IMG_WIDTH, IMG_HEIGHT)))
...
# Apply contour extraction to get bounding box of each digit
...
def proc_user_img(img_file, model):
    ...
    for rect in digits_rectangles:
        ...
        im_digit = resize(im_digit,(IMG_WIDTH ,IMG_HEIGHT))
...
TRAIN_MNIST_IMG = 'workshop_svm_image_feature_digits.png' 
TEST_USER_IMG = 'workshop_svm_image_feature_test_image.png'
