"""
KE5206 CI1, demo on linear SVM
Reference: Support Vector Machines for Classification
Code: https://github.com/mubaris/studious-eureka
...
# Import Dataset
data = pd.read_csv('demo_svm_linear_draw.csv', header=None)
X = data.values[:, :2]
y = data.values[:, 2]
