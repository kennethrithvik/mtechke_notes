...
1. Download stanford-postagger-full-2018-02-27.zip and stanford-ner-2018-02-27.zip 
...
pos_model_path = 'C:\\tools\\stanford-postagger-full-2018-02-27\\models\\english-bidirectional-distsim.tagger'
pos_jar_path = 'C:\\tools\\stanford-postagger-full-2018-02-27\\stanford-postagger.jar'
...
ner_model_path = 'C:\\tools\\stanford-ner-2018-02-27\\classifiers\\english.all.3class.distsim.crf.ser.gz'
ner_jar_path = 'C:\\tools\\stanford-ner-2018-02-27\\stanford-ner.jar'
...
ner7_model_path = 'C:\\tools\\stanford-ner-2018-02-27\\classifiers\\english.muc.7class.distsim.crf.ser.gz'
...
'''
# 1. Download stanford-corenlp-full-2018-02-27.zip 
...
#    with prompt line command "python -m pip install stanfordcorenlp"
...
nlp = StanfordCoreNLP('C:\\tools\\stanford-corenlp-full-2018-02-27\\')
